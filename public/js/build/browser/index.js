...
(function(global, factory) {
      ...
      },
      {
        ...
        value: function getSymbologySettings(symbology) {
          if (this.symbologySettings.has(symbology)) return this.symbologySettings.get(symbology);
            ...
            -1 !== _Object$values(exports.Barcode.Symbology).indexOf(symbology)
          ) {
          ...
          if ("object" === ("undefined" === typeof symbology ? "undefined" : _typeof(symbology))) {
            ...
            try {
              for (
                ...
                var s = _step.value;
                if (!(s in exports.Barcode.Symbology || -1 !== _Object$values(exports.Barcode.Symbology).indexOf(s)))
        ...
        value: function setupVideoElement() {
          ...
          this.videoElement.addEventListener("canplay", function() {
            if (null != _this2.cameraManager && null != _this2.cameraManager.activeCamera) {
              ...
              _this2.setMirrorImageEnabled(_this2.cameraManager.activeCamera.cameraType === exports.Camera.Type.FRONT);
            }
          });
        }
      },
  ...
  (function(_EventEmitter) {
    ...
    function BarcodePickerEventEmitter() {
      ...
      return _possibleConstructorReturn(
        this,
        (BarcodePickerEventEmitter.__proto__ || _Object$getPrototypeOf(BarcodePickerEventEmitter)).apply(
          this,
          arguments
        )
      );
  ...
  exports.BarcodePicker = (function() {
    function BarcodePicker(originElement) {
      ...
      var _ref = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        guiStyle = void 0 === _ref$guiStyle ? BarcodePicker.GuiStyle.LASER : _ref$guiStyle,
        _ref$videoFit = _ref.videoFit,
        videoFit = void 0 === _ref$videoFit ? BarcodePicker.ObjectFit.CONTAIN : _ref$videoFit,
