...
const barcodePickerGui_1 = require("./barcodePickerGui");
const browserHelper_1 = require("./browserHelper");
const customError_1 = require("./customError");
const dummyCameraManager_1 = require("./dummyCameraManager");
const scanner_1 = require("./scanner");
const scanSettings_1 = require("./scanSettings");
/**
 * @hidden
 */
class BarcodePickerEventEmitter extends eventemitter3_1.EventEmitter {
}
/**
 ...
 */
class BarcodePicker {
    constructor(originElement, { visible = true, singleImageMode = false, playSoundOnScan = false, vibrateOnScan = false, scanningPaused = false, guiStyle = BarcodePicker.GuiStyle.LASER, videoFit = BarcodePicker.ObjectFit.CONTAIN, scanner, scanSettings = new scanSettings_1.ScanSettings(), targetScanningFPS = 30 } = {}) {
    ...
    static create(originElement, { visible = true, singleImageMode = {
    ...
    }, playSoundOnScan = false, vibrateOnScan = false, scanningPaused = false, guiStyle = BarcodePicker.GuiStyle.LASER, videoFit = BarcodePicker.ObjectFit.CONTAIN, scanner, scanSettings = new scanSettings_1.ScanSettings(), enableCameraSwitcher = true, enableTorchToggle = true, enableTapToFocus = true, enablePinchToZoom = true, accessCamera = true, camera, cameraSettings, targetScanningFPS = 30 } = {}) {
        let singleImageModeForced;
        let singleImageModeFallbackAllowed;
        const deviceType = browserHelper_1.BrowserHelper.userAgentInfo.getDevice().type;
        ...
        if (accessCamera) {
            barcodePicker.cameraManager.setupCameras().then(() => {
