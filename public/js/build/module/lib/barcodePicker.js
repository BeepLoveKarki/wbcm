...
export class BarcodePicker {
    constructor(originElement, { visible = true, singleImageMode = false, playSoundOnScan = false, vibrateOnScan = false, scanningPaused = false, guiStyle = BarcodePicker.GuiStyle.LASER, videoFit = BarcodePicker.ObjectFit.CONTAIN, scanner, scanSettings = new ScanSettings(), targetScanningFPS = 30 } = {}) {
